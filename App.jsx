...
// ── KH SUMMER PLAN ────────────────────────────────────────────────────────────
const KH_SUMMER_PLAN = {
  name: "12-Week Summer Strength",
  weeks: [
    {
      week: 1, phase: 1,
      days: [
        {
          id: "kh-w1d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w1d1e1", name: "Pull-Ups or Inverted Rows", sets: 2, reps: "10–12 reps or max", section: "Pull", videoUrl: "" },
            { id: "kh-w1d1e2", name: "Dumbbell Row / Plank Hold", sets: 2, reps: "10 reps each side / 20 sec", section: "Pull", videoUrl: "" },
            { id: "kh-w1d1e3", name: "Rear Delt Fly / Side Plank", sets: 2, reps: "10 reps / 20 sec each side", section: "Core & Rear Delt", videoUrl: "" },
            { id: "kh-w1d1e4", name: "Tricep Overhead Extension", sets: 2, reps: "12 reps", section: "Arms", videoUrl: "" },
          ],
        },
        {
          id: "kh-w1d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w1d2e1", name: "Barbell or Goblet Squat", sets: 2, reps: "10 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w1d2e2", name: "Floor Dumbbell Hamstring Curl", sets: 2, reps: "12 reps", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w1d2e3", name: "Lateral Band Walks", sets: 2, reps: "15 steps each direction", section: "Adductors", videoUrl: "" },
            { id: "kh-w1d2e4", name: "Glute Bridge", sets: 2, reps: "15 reps", section: "Glutes", videoUrl: "" },
          ],
        },
        {
          id: "kh-w1d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w1d3e1", name: "Dumbbell Shoulder Press", sets: 2, reps: "12 reps", section: "Shoulders", videoUrl: "" },
            { id: "kh-w1d3e2", name: "Dumbbell Fly on Floor or Bench", sets: 2, reps: "12 reps", section: "Chest", videoUrl: "" },
            { id: "kh-w1d3e3", name: "Flat Hex Press + Incline Pushups", sets: 2, reps: "10 presses + pushups to fail", section: "Chest & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w1d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w1d4e1", name: "Bench Circuit — Step Up / Rev Lunge / Knee Tuck / Bicycles / Bench Hop / Incline Plank", sets: 2, reps: "5 each / 20 / 20 / 20 / hold", section: "Conditioning", videoUrl: "" },
            { id: "kh-w1d4e2", name: "Floor Circuit — Mountain Climbers / Plank / Bicycle Crunches", sets: 2, reps: "20 / 30 sec / 20", section: "Core", videoUrl: "" },
            { id: "kh-w1d4e3", name: "Alternating Bicep Curls", sets: 2, reps: "8 reps each arm", section: "Biceps", videoUrl: "" },
            { id: "kh-w1d4e4", name: "Tricep Overhead Extension", sets: 2, reps: "12 reps", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w1d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w1d5e1", name: "Sumo Goblet Squat", sets: 2, reps: "12 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w1d5e2", name: "Romanian Deadlift", sets: 2, reps: "10 reps", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w1d5e3", name: "Bulgarian Split Squat", sets: 2, reps: "10 reps each leg", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w1d5e4", name: "Banded Hip Thrust", sets: 2, reps: "15 reps", section: "Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w2d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w2d1e1", name: "Wide Dumbbell Row / Russian Twists", sets: 2, reps: "10 rows / 20 twists", section: "Pull & Core", videoUrl: "" },
            { id: "kh-w2d1e2", name: "Seated Dumbbell Row / Dumbbell Curl", sets: 2, reps: "12 rows / 10 curls", section: "Back & Biceps", videoUrl: "" },
            { id: "kh-w2d1e3", name: "Band Stretcher / Up-and-Overs", sets: 2, reps: "12 each", section: "Back & Core", videoUrl: "" },
            { id: "kh-w2d1e4", name: "Dumbbell Pullover / Reverse Crunches", sets: 2, reps: "10 pullovers / 15 crunches", section: "Back & Core", videoUrl: "" },
          ],
        },
        {
          id: "kh-w2d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w2d2e1", name: "Slow Goblet Squat (3 sec down)", sets: 2, reps: "12 reps", section: "Quads", videoUrl: "" },
            { id: "kh-w2d2e2", name: "Alternating Reverse Lunges", sets: 2, reps: "16 reps total", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w2d2e3", name: "Goblet Squat Variation or Barbell Squat", sets: 2, reps: "10 reps", section: "Quads", videoUrl: "" },
            { id: "kh-w2d2e4", name: "Lateral Band Walks", sets: 2, reps: "15 steps each direction", section: "Adductors", videoUrl: "" },
          ],
        },
        {
          id: "kh-w2d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w2d3e1", name: "Upright Row / Shoulder Press Superset", sets: 2, reps: "12 reps each", section: "Shoulders", videoUrl: "" },
            { id: "kh-w2d3e2", name: "Dumbbell Fly on Floor or Bench", sets: 2, reps: "10 reps", section: "Chest", videoUrl: "" },
            { id: "kh-w2d3e3", name: "Band Face Pulls / Band Tricep Pushdowns", sets: 2, reps: "15 face pulls / 12 pushdowns", section: "Rear Delt & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w2d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w2d4e1", name: "Core Circuit — V-Ups / Wall Crunches / Flutter Kicks / Dead Bug", sets: 2, reps: "10 / 15 / 20 / 10", section: "Core", videoUrl: "" },
            { id: "kh-w2d4e2", name: "Band Circuit — Jump Squats / Band Side Steps / Banded Glute Bridge", sets: 2, reps: "10 / 20 / 15", section: "Full Body", videoUrl: "" },
            { id: "kh-w2d4e3", name: "Incline Spider Curls", sets: 2, reps: "20 total reps", section: "Biceps", videoUrl: "" },
            { id: "kh-w2d4e4", name: "Seated Overhead Tricep Extension", sets: 2, reps: "12 reps", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w2d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w2d5e1", name: "Band Pull-Throughs", sets: 2, reps: "12 reps", section: "Glutes & Hamstrings", videoUrl: "" },
            { id: "kh-w2d5e2", name: "Walking Lunges", sets: 2, reps: "20 reps total", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w2d5e3", name: "Single Leg RDL", sets: 2, reps: "10 reps each side", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w2d5e4", name: "Floor Hamstring Curl / Banded Kickback", sets: 2, reps: "10 curls / 15 kickbacks each", section: "Hamstrings & Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w3d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w3d1e1", name: "Deadlift", sets: 2, reps: "8 reps (2 warm-up + 2 working)", section: "Back & Hamstrings", videoUrl: "" },
            { id: "kh-w3d1e2", name: "Seated Dumbbell Row / Shotguns", sets: 2, reps: "12 rows / 15 shotguns", section: "Back & Core", videoUrl: "" },
            { id: "kh-w3d1e3", name: "Band Stretcher / Wood Choppers", sets: 2, reps: "10 each side", section: "Back & Core", videoUrl: "" },
            { id: "kh-w3d1e4", name: "Band Lat Pulldown / Band Pull-Aparts", sets: 2, reps: "12 pulldowns / 15 pull-aparts", section: "Back & Rear Delt", videoUrl: "" },
          ],
        },
        {
          id: "kh-w3d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w3d2e1", name: "Pause Squat (3 sec hold at parallel)", sets: 2, reps: "8 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w3d2e2", name: "Goblet Squat or Leg Press Workaround", sets: 2, reps: "12 reps", section: "Quads", videoUrl: "" },
            { id: "kh-w3d2e3", name: "Step-Ups", sets: 2, reps: "10 reps each leg", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w3d2e4", name: "Calf Raises", sets: 2, reps: "15 toes in / 15 forward / 15 out", section: "Calves", videoUrl: "" },
          ],
        },
        {
          id: "kh-w3d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w3d3e1", name: "Dumbbell Fly / Dumbbell Press Superset", sets: 2, reps: "10 flyes / 10 presses", section: "Chest", videoUrl: "" },
            { id: "kh-w3d3e2", name: "Single Arm Side Raise", sets: 2, reps: "12 reps each side", section: "Shoulders", videoUrl: "" },
            { id: "kh-w3d3e3", name: "Arnold Press / Half Arnolds", sets: 2, reps: "5 full + 10 half", section: "Shoulders", videoUrl: "" },
            { id: "kh-w3d3e4", name: "Incline Pushup / Dips", sets: 2, reps: "10 pushups / 12 dips", section: "Chest & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w3d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w3d4e1", name: "Core & Glute Circuit — Crunches / Glute Bridge / Bicycles / Supermans / Kickback Plank", sets: 2, reps: "10 / 10 / 20 / 10 / 10 each", section: "Core & Glutes", videoUrl: "" },
            { id: "kh-w3d4e2", name: "Floor Circuit — Russian Twists / Leg Pass / Plank", sets: 2, reps: "20 / 10 / 30 sec", section: "Core", videoUrl: "" },
            { id: "kh-w3d4e3", name: "Preacher Curl (bench as preacher)", sets: 2, reps: "10 reps", section: "Biceps", videoUrl: "" },
            { id: "kh-w3d4e4", name: "Single Arm Dumbbell Kickback", sets: 2, reps: "12 reps each arm", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w3d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w3d5e1", name: "Sumo Pulse Squats", sets: 2, reps: "12 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w3d5e2", name: "Hip Thrusts", sets: 2, reps: "8 reps (2 sec hold at top)", section: "Glutes", videoUrl: "" },
            { id: "kh-w3d5e3", name: "Duck Walks", sets: 2, reps: "5 walks (4–6 steps each)", section: "Glutes & Hamstrings", videoUrl: "" },
            { id: "kh-w3d5e4", name: "Slow Hamstring Curl / Banded Kickback", sets: 2, reps: "10 curls (3 sec) / 12 kickbacks each", section: "Hamstrings & Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w4d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w4d1e1", name: "Sumo Deadlift", sets: 2, reps: "8 reps (2 warm-up + 2 working)", section: "Back & Hamstrings", videoUrl: "" },
            { id: "kh-w4d1e2", name: "Bent Over Barbell Row / Dumbbell Shrugs", sets: 2, reps: "12 rows / 15 shrugs", section: "Back & Traps", videoUrl: "" },
            { id: "kh-w4d1e3", name: "Band Lat Pulldown / V-Ups", sets: 2, reps: "12 pulldowns / 10 V-ups", section: "Back & Core", videoUrl: "" },
            { id: "kh-w4d1e4", name: "Rear Delt Fly / Reverse Crunches", sets: 2, reps: "10 flyes / 12 crunches", section: "Rear Delt & Core", videoUrl: "" },
          ],
        },
        {
          id: "kh-w4d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w4d2e1", name: "Barbell Front Squat or Goblet Squat", sets: 2, reps: "10 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w4d2e2", name: "Lateral Band Walks", sets: 2, reps: "15 steps each direction", section: "Adductors", videoUrl: "" },
            { id: "kh-w4d2e3", name: "Goblet Squat / Wall Sit", sets: 2, reps: "12 squats / 30 sec sit", section: "Quads", videoUrl: "" },
            { id: "kh-w4d2e4", name: "Bodyweight Ice Skaters", sets: 2, reps: "10 each side", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w4d2e5", name: "Calf Raises", sets: 2, reps: "10 in / 10 forward / 10 out / 10 forward", section: "Calves", videoUrl: "" },
          ],
        },
        {
          id: "kh-w4d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w4d3e1", name: "6-Way Shoulder Raise", sets: 2, reps: "5–6 reps", section: "Shoulders", videoUrl: "" },
            { id: "kh-w4d3e2", name: "Single Arm Upright Row to Press", sets: 2, reps: "10 reps each side", section: "Shoulders", videoUrl: "" },
            { id: "kh-w4d3e3", name: "Incline Chest Press", sets: 2, reps: "10 reps", section: "Chest", videoUrl: "" },
            { id: "kh-w4d3e4", name: "Dumbbell Fly / Skull Crushers Superset", sets: 2, reps: "10 flyes / 12 crushers", section: "Chest & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w4d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w4d4e1", name: "Fast/Slow Circuit — Bicycles / Slow Bicycles / Plank Shoulder Taps / Slow Mountain Climbers", sets: 2, reps: "10 each side / 10 slow / 20 / 10 slow", section: "Core", videoUrl: "" },
            { id: "kh-w4d4e2", name: "Bench Circuit — Bench Jumps / Mountain Climbers / Burpees / Box Step-Overs", sets: 2, reps: "10 / 20 / 10 / 10", section: "Full Body", videoUrl: "" },
            { id: "kh-w4d4e3", name: "Dumbbell Bicep Curls", sets: 2, reps: "10 reps", section: "Biceps", videoUrl: "" },
            { id: "kh-w4d4e4", name: "Band 20-20s (20 underhand + 20 overhand pushdowns)", sets: 2, reps: "20 + 20", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w4d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w4d5e1", name: "Dumbbell Kneeling Squats / Banded Hip Thrusts", sets: 2, reps: "10 kneeling squats / 12 hip thrusts", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w4d5e2", name: "Elevated Curtsy Lunge / Side Steps", sets: 2, reps: "8 alternating lunges / 15 side steps", section: "Glutes & Adductors", videoUrl: "" },
            { id: "kh-w4d5e3", name: "Band Pull-Throughs", sets: 2, reps: "15 reps", section: "Glutes & Hamstrings", videoUrl: "" },
            { id: "kh-w4d5e4", name: "Dumbbell Hamstring Curl on Bench", sets: 2, reps: "10 reps", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w4d5e5", name: "Banded Kickbacks / Frog Squats", sets: 2, reps: "12 kickbacks each / 10 squats", section: "Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w5d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w5d1e1", name: "Pull-Ups or Inverted Rows", sets: 3, reps: "10–12 reps or max", section: "Pull", videoUrl: "" },
            { id: "kh-w5d1e2", name: "Dumbbell Row / Plank Hold", sets: 3, reps: "10 reps each side / 20 sec", section: "Pull", videoUrl: "" },
            { id: "kh-w5d1e3", name: "Rear Delt Fly / Side Plank", sets: 3, reps: "10 reps / 20 sec each side", section: "Core & Rear Delt", videoUrl: "" },
            { id: "kh-w5d1e4", name: "Tricep Overhead Extension", sets: 3, reps: "12 reps", section: "Arms", videoUrl: "" },
          ],
        },
        {
          id: "kh-w5d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w5d2e1", name: "Barbell or Goblet Squat", sets: 3, reps: "10 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w5d2e2", name: "Floor Dumbbell Hamstring Curl", sets: 3, reps: "12 reps", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w5d2e3", name: "Lateral Band Walks", sets: 3, reps: "15 steps each direction", section: "Adductors", videoUrl: "" },
            { id: "kh-w5d2e4", name: "Glute Bridge", sets: 3, reps: "15 reps", section: "Glutes", videoUrl: "" },
          ],
        },
        {
          id: "kh-w5d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w5d3e1", name: "Dumbbell Shoulder Press", sets: 3, reps: "12 reps", section: "Shoulders", videoUrl: "" },
            { id: "kh-w5d3e2", name: "Dumbbell Fly on Floor or Bench", sets: 3, reps: "12 reps", section: "Chest", videoUrl: "" },
            { id: "kh-w5d3e3", name: "Flat Hex Press + Incline Pushups", sets: 3, reps: "10 presses + pushups to fail", section: "Chest & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w5d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w5d4e1", name: "Bench Circuit — Step Up / Rev Lunge / Knee Tuck / Bicycles / Bench Hop / Incline Plank", sets: 3, reps: "5 each / 20 / 20 / 20 / hold", section: "Conditioning", videoUrl: "" },
            { id: "kh-w5d4e2", name: "Floor Circuit — Mountain Climbers / Plank / Bicycle Crunches", sets: 3, reps: "20 / 30 sec / 20", section: "Core", videoUrl: "" },
            { id: "kh-w5d4e3", name: "Alternating Bicep Curls", sets: 3, reps: "8 reps each arm", section: "Biceps", videoUrl: "" },
            { id: "kh-w5d4e4", name: "Tricep Overhead Extension", sets: 3, reps: "12 reps", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w5d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w5d5e1", name: "Sumo Goblet Squat", sets: 3, reps: "12 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w5d5e2", name: "Romanian Deadlift", sets: 3, reps: "10 reps", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w5d5e3", name: "Bulgarian Split Squat", sets: 3, reps: "10 reps each leg", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w5d5e4", name: "Banded Hip Thrust", sets: 3, reps: "15 reps", section: "Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w6d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w6d1e1", name: "Wide Dumbbell Row / Russian Twists", sets: 3, reps: "10 rows / 20 twists", section: "Pull & Core", videoUrl: "" },
            { id: "kh-w6d1e2", name: "Seated Dumbbell Row / Dumbbell Curl", sets: 3, reps: "12 rows / 10 curls", section: "Back & Biceps", videoUrl: "" },
            { id: "kh-w6d1e3", name: "Band Stretcher / Up-and-Overs", sets: 3, reps: "12 each", section: "Back & Core", videoUrl: "" },
            { id: "kh-w6d1e4", name: "Dumbbell Pullover / Reverse Crunches", sets: 3, reps: "10 pullovers / 15 crunches", section: "Back & Core", videoUrl: "" },
          ],
        },
        {
          id: "kh-w6d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w6d2e1", name: "Slow Goblet Squat (3 sec down)", sets: 3, reps: "12 reps", section: "Quads", videoUrl: "" },
            { id: "kh-w6d2e2", name: "Alternating Reverse Lunges", sets: 3, reps: "16 reps total", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w6d2e3", name: "Goblet Squat Variation or Barbell Squat", sets: 3, reps: "10 reps", section: "Quads", videoUrl: "" },
            { id: "kh-w6d2e4", name: "Lateral Band Walks", sets: 3, reps: "15 steps each direction", section: "Adductors", videoUrl: "" },
          ],
        },
        {
          id: "kh-w6d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w6d3e1", name: "Upright Row / Shoulder Press Superset", sets: 3, reps: "12 reps each", section: "Shoulders", videoUrl: "" },
            { id: "kh-w6d3e2", name: "Dumbbell Fly on Floor or Bench", sets: 3, reps: "10 reps", section: "Chest", videoUrl: "" },
            { id: "kh-w6d3e3", name: "Band Face Pulls / Band Tricep Pushdowns", sets: 3, reps: "15 face pulls / 12 pushdowns", section: "Rear Delt & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w6d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w6d4e1", name: "Core Circuit — V-Ups / Wall Crunches / Flutter Kicks / Dead Bug", sets: 3, reps: "10 / 15 / 20 / 10", section: "Core", videoUrl: "" },
            { id: "kh-w6d4e2", name: "Band Circuit — Jump Squats / Band Side Steps / Banded Glute Bridge", sets: 3, reps: "10 / 20 / 15", section: "Full Body", videoUrl: "" },
            { id: "kh-w6d4e3", name: "Incline Spider Curls", sets: 3, reps: "20 total reps", section: "Biceps", videoUrl: "" },
            { id: "kh-w6d4e4", name: "Seated Overhead Tricep Extension", sets: 3, reps: "12 reps", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w6d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w6d5e1", name: "Band Pull-Throughs", sets: 3, reps: "12 reps", section: "Glutes & Hamstrings", videoUrl: "" },
            { id: "kh-w6d5e2", name: "Walking Lunges", sets: 3, reps: "20 reps total", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w6d5e3", name: "Single Leg RDL", sets: 3, reps: "10 reps each side", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w6d5e4", name: "Floor Hamstring Curl / Banded Kickback", sets: 3, reps: "10 curls / 15 kickbacks each", section: "Hamstrings & Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w7d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w7d1e1", name: "Deadlift", sets: 3, reps: "8 reps (2 warm-up + 2 working)", section: "Back & Hamstrings", videoUrl: "" },
            { id: "kh-w7d1e2", name: "Seated Dumbbell Row / Shotguns", sets: 3, reps: "12 rows / 15 shotguns", section: "Back & Core", videoUrl: "" },
            { id: "kh-w7d1e3", name: "Band Stretcher / Wood Choppers", sets: 3, reps: "10 each side", section: "Back & Core", videoUrl: "" },
            { id: "kh-w7d1e4", name: "Band Lat Pulldown / Band Pull-Aparts", sets: 3, reps: "12 pulldowns / 15 pull-aparts", section: "Back & Rear Delt", videoUrl: "" },
          ],
        },
        {
          id: "kh-w7d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w7d2e1", name: "Pause Squat (3 sec hold at parallel)", sets: 3, reps: "8 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w7d2e2", name: "Goblet Squat or Leg Press Workaround", sets: 3, reps: "12 reps", section: "Quads", videoUrl: "" },
            { id: "kh-w7d2e3", name: "Step-Ups", sets: 3, reps: "10 reps each leg", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w7d2e4", name: "Calf Raises", sets: 3, reps: "15 toes in / 15 forward / 15 out", section: "Calves", videoUrl: "" },
          ],
        },
        {
          id: "kh-w7d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w7d3e1", name: "Dumbbell Fly / Dumbbell Press Superset", sets: 3, reps: "10 flyes / 10 presses", section: "Chest", videoUrl: "" },
            { id: "kh-w7d3e2", name: "Single Arm Side Raise", sets: 3, reps: "12 reps each side", section: "Shoulders", videoUrl: "" },
            { id: "kh-w7d3e3", name: "Arnold Press / Half Arnolds", sets: 3, reps: "5 full + 10 half", section: "Shoulders", videoUrl: "" },
            { id: "kh-w7d3e4", name: "Incline Pushup / Dips", sets: 3, reps: "10 pushups / 12 dips", section: "Chest & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w7d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w7d4e1", name: "Core & Glute Circuit — Crunches / Glute Bridge / Bicycles / Supermans / Kickback Plank", sets: 3, reps: "10 / 10 / 20 / 10 / 10 each", section: "Core & Glutes", videoUrl: "" },
            { id: "kh-w7d4e2", name: "Floor Circuit — Russian Twists / Leg Pass / Plank", sets: 3, reps: "20 / 10 / 30 sec", section: "Core", videoUrl: "" },
            { id: "kh-w7d4e3", name: "Preacher Curl (bench as preacher)", sets: 3, reps: "10 reps", section: "Biceps", videoUrl: "" },
            { id: "kh-w7d4e4", name: "Single Arm Dumbbell Kickback", sets: 3, reps: "12 reps each arm", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w7d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w7d5e1", name: "Sumo Pulse Squats", sets: 3, reps: "12 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w7d5e2", name: "Hip Thrusts", sets: 3, reps: "8 reps (2 sec hold at top)", section: "Glutes", videoUrl: "" },
            { id: "kh-w7d5e3", name: "Duck Walks", sets: 3, reps: "5 walks (4–6 steps each)", section: "Glutes & Hamstrings", videoUrl: "" },
            { id: "kh-w7d5e4", name: "Slow Hamstring Curl / Banded Kickback", sets: 3, reps: "10 curls (3 sec) / 12 kickbacks each", section: "Hamstrings & Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w8d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w8d1e1", name: "Sumo Deadlift", sets: 3, reps: "8 reps (2 warm-up + 2 working)", section: "Back & Hamstrings", videoUrl: "" },
            { id: "kh-w8d1e2", name: "Bent Over Barbell Row / Dumbbell Shrugs", sets: 3, reps: "12 rows / 15 shrugs", section: "Back & Traps", videoUrl: "" },
            { id: "kh-w8d1e3", name: "Band Lat Pulldown / V-Ups", sets: 3, reps: "12 pulldowns / 10 V-ups", section: "Back & Core", videoUrl: "" },
            { id: "kh-w8d1e4", name: "Rear Delt Fly / Reverse Crunches", sets: 3, reps: "10 flyes / 12 crunches", section: "Rear Delt & Core", videoUrl: "" },
          ],
        },
        {
          id: "kh-w8d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w8d2e1", name: "Barbell Front Squat or Goblet Squat", sets: 3, reps: "10 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w8d2e2", name: "Lateral Band Walks", sets: 3, reps: "15 steps each direction", section: "Adductors", videoUrl: "" },
            { id: "kh-w8d2e3", name: "Goblet Squat / Wall Sit", sets: 3, reps: "12 squats / 30 sec sit", section: "Quads", videoUrl: "" },
            { id: "kh-w8d2e4", name: "Bodyweight Ice Skaters", sets: 3, reps: "10 each side", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w8d2e5", name: "Calf Raises", sets: 3, reps: "10 in / 10 forward / 10 out / 10 forward", section: "Calves", videoUrl: "" },
          ],
        },
        {
          id: "kh-w8d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w8d3e1", name: "6-Way Shoulder Raise", sets: 3, reps: "5–6 reps", section: "Shoulders", videoUrl: "" },
            { id: "kh-w8d3e2", name: "Single Arm Upright Row to Press", sets: 3, reps: "10 reps each side", section: "Shoulders", videoUrl: "" },
            { id: "kh-w8d3e3", name: "Incline Chest Press", sets: 3, reps: "10 reps", section: "Chest", videoUrl: "" },
            { id: "kh-w8d3e4", name: "Dumbbell Fly / Skull Crushers Superset", sets: 3, reps: "10 flyes / 12 crushers", section: "Chest & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w8d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w8d4e1", name: "Fast/Slow Circuit — Bicycles / Slow Bicycles / Plank Shoulder Taps / Slow Mountain Climbers", sets: 3, reps: "10 each side / 10 slow / 20 / 10 slow", section: "Core", videoUrl: "" },
            { id: "kh-w8d4e2", name: "Bench Circuit — Bench Jumps / Mountain Climbers / Burpees / Box Step-Overs", sets: 3, reps: "10 / 20 / 10 / 10", section: "Full Body", videoUrl: "" },
            { id: "kh-w8d4e3", name: "Dumbbell Bicep Curls", sets: 3, reps: "10 reps", section: "Biceps", videoUrl: "" },
            { id: "kh-w8d4e4", name: "Band 20-20s (20 underhand + 20 overhand pushdowns)", sets: 3, reps: "20 + 20", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w8d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w8d5e1", name: "Dumbbell Kneeling Squats / Banded Hip Thrusts", sets: 3, reps: "10 kneeling squats / 12 hip thrusts", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w8d5e2", name: "Elevated Curtsy Lunge / Side Steps", sets: 3, reps: "8 alternating lunges / 15 side steps", section: "Glutes & Adductors", videoUrl: "" },
            { id: "kh-w8d5e3", name: "Band Pull-Throughs", sets: 3, reps: "15 reps", section: "Glutes & Hamstrings", videoUrl: "" },
            { id: "kh-w8d5e4", name: "Dumbbell Hamstring Curl on Bench", sets: 3, reps: "10 reps", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w8d5e5", name: "Banded Kickbacks / Frog Squats", sets: 3, reps: "12 kickbacks each / 10 squats", section: "Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w9d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w9d1e1", name: "Pull-Ups or Inverted Rows", sets: 3, reps: "10–12 reps or max", section: "Pull", videoUrl: "" },
            { id: "kh-w9d1e2", name: "Dumbbell Row / Plank Hold", sets: 3, reps: "10 reps each side / 20 sec", section: "Pull", videoUrl: "" },
            { id: "kh-w9d1e3", name: "Rear Delt Fly / Side Plank", sets: 3, reps: "10 reps / 20 sec each side", section: "Core & Rear Delt", videoUrl: "" },
            { id: "kh-w9d1e4", name: "Tricep Overhead Extension", sets: 3, reps: "12–15 reps", section: "Arms", videoUrl: "" },
          ],
        },
        {
          id: "kh-w9d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w9d2e1", name: "Barbell or Goblet Squat", sets: 3, reps: "10–12 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w9d2e2", name: "Floor Dumbbell Hamstring Curl", sets: 3, reps: "12–15 reps", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w9d2e3", name: "Lateral Band Walks", sets: 3, reps: "15 steps each direction", section: "Adductors", videoUrl: "" },
            { id: "kh-w9d2e4", name: "Glute Bridge", sets: 3, reps: "15–20 reps", section: "Glutes", videoUrl: "" },
          ],
        },
        {
          id: "kh-w9d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w9d3e1", name: "Dumbbell Shoulder Press", sets: 3, reps: "12–15 reps", section: "Shoulders", videoUrl: "" },
            { id: "kh-w9d3e2", name: "Dumbbell Fly on Floor or Bench", sets: 3, reps: "12–15 reps", section: "Chest", videoUrl: "" },
            { id: "kh-w9d3e3", name: "Flat Hex Press + Incline Pushups", sets: 3, reps: "10 presses + pushups to fail", section: "Chest & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w9d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w9d4e1", name: "Bench Circuit — Step Up / Rev Lunge / Knee Tuck / Bicycles / Bench Hop / Incline Plank", sets: 3, reps: "5 each / 20 / 20 / 20 / hold", section: "Conditioning", videoUrl: "" },
            { id: "kh-w9d4e2", name: "Floor Circuit — Mountain Climbers / Plank / Bicycle Crunches", sets: 3, reps: "20 / 30 sec / 20", section: "Core", videoUrl: "" },
            { id: "kh-w9d4e3", name: "Alternating Bicep Curls", sets: 3, reps: "8 reps each arm", section: "Biceps", videoUrl: "" },
            { id: "kh-w9d4e4", name: "Tricep Overhead Extension", sets: 3, reps: "12–15 reps", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w9d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w9d5e1", name: "Sumo Goblet Squat", sets: 3, reps: "12–15 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w9d5e2", name: "Romanian Deadlift", sets: 3, reps: "10–12 reps", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w9d5e3", name: "Bulgarian Split Squat", sets: 3, reps: "12 reps each leg", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w9d5e4", name: "Banded Hip Thrust", sets: 3, reps: "15–20 reps", section: "Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w10d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w10d1e1", name: "Wide Dumbbell Row / Russian Twists", sets: 3, reps: "10 rows / 20 twists", section: "Pull & Core", videoUrl: "" },
            { id: "kh-w10d1e2", name: "Seated Dumbbell Row / Dumbbell Curl", sets: 3, reps: "12 rows / 10 curls", section: "Back & Biceps", videoUrl: "" },
            { id: "kh-w10d1e3", name: "Band Stretcher / Up-and-Overs", sets: 3, reps: "12 each", section: "Back & Core", videoUrl: "" },
            { id: "kh-w10d1e4", name: "Dumbbell Pullover / Reverse Crunches", sets: 3, reps: "10 pullovers / 15 crunches", section: "Back & Core", videoUrl: "" },
          ],
        },
        {
          id: "kh-w10d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w10d2e1", name: "Slow Goblet Squat (3 sec down)", sets: 3, reps: "12–15 reps", section: "Quads", videoUrl: "" },
            { id: "kh-w10d2e2", name: "Alternating Reverse Lunges", sets: 3, reps: "16 reps total", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w10d2e3", name: "Goblet Squat Variation or Barbell Squat", sets: 3, reps: "10–12 reps", section: "Quads", videoUrl: "" },
            { id: "kh-w10d2e4", name: "Lateral Band Walks", sets: 3, reps: "15 steps each direction", section: "Adductors", videoUrl: "" },
          ],
        },
        {
          id: "kh-w10d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w10d3e1", name: "Upright Row / Shoulder Press Superset", sets: 3, reps: "15 reps each", section: "Shoulders", videoUrl: "" },
            { id: "kh-w10d3e2", name: "Dumbbell Fly on Floor or Bench", sets: 3, reps: "10–12 reps", section: "Chest", videoUrl: "" },
            { id: "kh-w10d3e3", name: "Band Face Pulls / Band Tricep Pushdowns", sets: 3, reps: "15 face pulls / 12 pushdowns", section: "Rear Delt & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w10d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w10d4e1", name: "Core Circuit — V-Ups / Wall Crunches / Flutter Kicks / Dead Bug", sets: 3, reps: "10 / 15 / 20 / 10", section: "Core", videoUrl: "" },
            { id: "kh-w10d4e2", name: "Band Circuit — Jump Squats / Band Side Steps / Banded Glute Bridge", sets: 3, reps: "10 / 20 / 15", section: "Full Body", videoUrl: "" },
            { id: "kh-w10d4e3", name: "Incline Spider Curls", sets: 3, reps: "20 total reps", section: "Biceps", videoUrl: "" },
            { id: "kh-w10d4e4", name: "Seated Overhead Tricep Extension", sets: 3, reps: "12–15 reps", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w10d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w10d5e1", name: "Band Pull-Throughs", sets: 3, reps: "12–15 reps", section: "Glutes & Hamstrings", videoUrl: "" },
            { id: "kh-w10d5e2", name: "Walking Lunges", sets: 3, reps: "20 reps total", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w10d5e3", name: "Single Leg RDL", sets: 3, reps: "12 reps each side", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w10d5e4", name: "Floor Hamstring Curl / Banded Kickback", sets: 3, reps: "10 curls / 15 kickbacks each", section: "Hamstrings & Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w11d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w11d1e1", name: "Deadlift", sets: 3, reps: "8 reps (heavier)", section: "Back & Hamstrings", videoUrl: "" },
            { id: "kh-w11d1e2", name: "Seated Dumbbell Row / Shotguns", sets: 3, reps: "12 rows / 15 shotguns", section: "Back & Core", videoUrl: "" },
            { id: "kh-w11d1e3", name: "Band Stretcher / Wood Choppers", sets: 3, reps: "10 each side", section: "Back & Core", videoUrl: "" },
            { id: "kh-w11d1e4", name: "Band Lat Pulldown / Band Pull-Aparts", sets: 3, reps: "12 pulldowns / 15 pull-aparts", section: "Back & Rear Delt", videoUrl: "" },
          ],
        },
        {
          id: "kh-w11d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w11d2e1", name: "Pause Squat (3 sec hold at parallel)", sets: 3, reps: "8–10 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w11d2e2", name: "Goblet Squat or Leg Press Workaround", sets: 3, reps: "12–15 reps", section: "Quads", videoUrl: "" },
            { id: "kh-w11d2e3", name: "Step-Ups", sets: 3, reps: "12 reps each leg", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w11d2e4", name: "Calf Raises", sets: 3, reps: "15 toes in / 15 forward / 15 out", section: "Calves", videoUrl: "" },
          ],
        },
        {
          id: "kh-w11d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w11d3e1", name: "Dumbbell Fly / Dumbbell Press Superset", sets: 3, reps: "10 flyes / 10 presses", section: "Chest", videoUrl: "" },
            { id: "kh-w11d3e2", name: "Single Arm Side Raise", sets: 3, reps: "15 reps each side", section: "Shoulders", videoUrl: "" },
            { id: "kh-w11d3e3", name: "Arnold Press / Half Arnolds", sets: 3, reps: "6 full + 12 half", section: "Shoulders", videoUrl: "" },
            { id: "kh-w11d3e4", name: "Incline Pushup / Dips", sets: 3, reps: "10 pushups / 12 dips", section: "Chest & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w11d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w11d4e1", name: "Core & Glute Circuit — Crunches / Glute Bridge / Bicycles / Supermans / Kickback Plank", sets: 3, reps: "10 / 10 / 20 / 10 / 10 each", section: "Core & Glutes", videoUrl: "" },
            { id: "kh-w11d4e2", name: "Floor Circuit — Russian Twists / Leg Pass / Plank", sets: 3, reps: "20 / 10 / 30 sec", section: "Core", videoUrl: "" },
            { id: "kh-w11d4e3", name: "Preacher Curl (bench as preacher)", sets: 3, reps: "10–12 reps", section: "Biceps", videoUrl: "" },
            { id: "kh-w11d4e4", name: "Single Arm Dumbbell Kickback", sets: 3, reps: "15 reps each arm", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w11d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w11d5e1", name: "Sumo Pulse Squats", sets: 3, reps: "12–15 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w11d5e2", name: "Hip Thrusts", sets: 3, reps: "10 reps (2 sec hold)", section: "Glutes", videoUrl: "" },
            { id: "kh-w11d5e3", name: "Duck Walks", sets: 3, reps: "5 walks (4–6 steps each)", section: "Glutes & Hamstrings", videoUrl: "" },
            { id: "kh-w11d5e4", name: "Slow Hamstring Curl / Banded Kickback", sets: 3, reps: "10 curls (3 sec) / 12 kickbacks each", section: "Hamstrings & Glutes", videoUrl: "" },
          ],
        },
      ],
    },
    {
      ...
      days: [
        {
          id: "kh-w12d1", label: "Upper Body 1 + Core", emoji: "💪",
          exercises: [
            { id: "kh-w12d1e1", name: "Sumo Deadlift", sets: 3, reps: "8 reps (heavier)", section: "Back & Hamstrings", videoUrl: "" },
            { id: "kh-w12d1e2", name: "Bent Over Barbell Row / Dumbbell Shrugs", sets: 3, reps: "12 rows / 15 shrugs", section: "Back & Traps", videoUrl: "" },
            { id: "kh-w12d1e3", name: "Band Lat Pulldown / V-Ups", sets: 3, reps: "12 pulldowns / 10 V-ups", section: "Back & Core", videoUrl: "" },
            { id: "kh-w12d1e4", name: "Rear Delt Fly / Reverse Crunches", sets: 3, reps: "10 flyes / 12 crunches", section: "Rear Delt & Core", videoUrl: "" },
          ],
        },
        {
          id: "kh-w12d2", label: "Legs 1 — Quad Focus", emoji: "🦵",
          exercises: [
            { id: "kh-w12d2e1", name: "Barbell Front Squat or Goblet Squat", sets: 3, reps: "10–12 reps", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w12d2e2", name: "Lateral Band Walks", sets: 3, reps: "15 steps each direction", section: "Adductors", videoUrl: "" },
            { id: "kh-w12d2e3", name: "Goblet Squat / Wall Sit", sets: 3, reps: "12 squats / 30 sec sit", section: "Quads", videoUrl: "" },
            { id: "kh-w12d2e4", name: "Bodyweight Ice Skaters", sets: 3, reps: "10 each side", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w12d2e5", name: "Calf Raises", sets: 3, reps: "10 in / 10 forward / 10 out / 10 forward", section: "Calves", videoUrl: "" },
          ],
        },
        {
          id: "kh-w12d3", label: "Upper Body 2 + Shoulders", emoji: "🔥",
          exercises: [
            { id: "kh-w12d3e1", name: "6-Way Shoulder Raise", sets: 3, reps: "6–8 reps", section: "Shoulders", videoUrl: "" },
            { id: "kh-w12d3e2", name: "Single Arm Upright Row to Press", sets: 3, reps: "12 reps each side", section: "Shoulders", videoUrl: "" },
            { id: "kh-w12d3e3", name: "Incline Chest Press", sets: 3, reps: "10–12 reps", section: "Chest", videoUrl: "" },
            { id: "kh-w12d3e4", name: "Dumbbell Fly / Skull Crushers Superset", sets: 3, reps: "10 flyes / 12 crushers", section: "Chest & Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w12d4", label: "Conditioning + Arms", emoji: "⚡",
          exercises: [
            { id: "kh-w12d4e1", name: "Fast/Slow Circuit — Bicycles / Slow Bicycles / Plank Shoulder Taps / Slow Mountain Climbers", sets: 3, reps: "10 each side / 10 slow / 20 / 10 slow", section: "Core", videoUrl: "" },
            { id: "kh-w12d4e2", name: "Bench Circuit — Bench Jumps / Mountain Climbers / Burpees / Box Step-Overs", sets: 3, reps: "10 / 20 / 10 / 10", section: "Full Body", videoUrl: "" },
            { id: "kh-w12d4e3", name: "Dumbbell Bicep Curls", sets: 3, reps: "10–12 reps", section: "Biceps", videoUrl: "" },
            { id: "kh-w12d4e4", name: "Band 20-20s (20 underhand + 20 overhand pushdowns)", sets: 3, reps: "20 + 20", section: "Triceps", videoUrl: "" },
          ],
        },
        {
          id: "kh-w12d5", label: "Legs 2 — Glute & Posterior", emoji: "🏋️",
          exercises: [
            { id: "kh-w12d5e1", name: "Dumbbell Kneeling Squats / Banded Hip Thrusts", sets: 3, reps: "10 kneeling squats / 12 hip thrusts", section: "Quads & Glutes", videoUrl: "" },
            { id: "kh-w12d5e2", name: "Elevated Curtsy Lunge / Side Steps", sets: 3, reps: "8 alternating lunges / 15 side steps", section: "Glutes & Adductors", videoUrl: "" },
            { id: "kh-w12d5e3", name: "Band Pull-Throughs", sets: 3, reps: "15–20 reps", section: "Glutes & Hamstrings", videoUrl: "" },
            { id: "kh-w12d5e4", name: "Dumbbell Hamstring Curl on Bench", sets: 3, reps: "10–12 reps", section: "Hamstrings", videoUrl: "" },
            { id: "kh-w12d5e5", name: "Banded Kickbacks / Frog Squats", sets: 3, reps: "12 kickbacks each / 10 squats", section: "Glutes", videoUrl: "" },
          ],
        },
      ],
    },
...
const LIBRARY_CATALOG = [
  ...
  },
  {
    id: "lib-kh-summer",
    name: "12-Week Summer Strength",
    description: "A home-friendly plan built for busy parents. 20–30 min sessions, 5 days/week. Progresses from 2 sets (weeks 1–4) to 3 sets with overload (weeks 9–12). All you need is dumbbells, bands, a bench, and a pull-up bar.",
    duration: "12 weeks",
    daysPerWeek: 5,
    difficulty: "Beginner–Intermediate",
    tags: ["Home", "Strength", "Stamina", "Heart Health"],
    access: "free",
    plan: KH_SUMMER_PLAN,
  },
];
...
// Scans the full wlog for all past entries matching this exercise name (across any day/week)
function getExerciseHistory(exName, currentDayId, fullLog) {
  const entries = [];
  Object.entries(fullLog).forEach(([key, data]) => {
    if (!data?.sets?.length) return;
    // Key format: "dayId::exerciseId" — skip current day
    const [dayId] = key.split("::");
    if (dayId === currentDayId) return;
    // Find matching exercise name by scanning plan data embedded in the key label
    // We store the exercise name in the log data so we can match by name
    if (data.exName && data.exName !== exName) return;
    if (!data.exName) return; // older entries without name skip gracefully
    const vol = data.sets.reduce((a,s)=>a+(parseFloat(s.weight)||0)*(parseInt(s.reps)||0),0);
    const maxW = Math.max(...data.sets.map(s=>parseFloat(s.weight)||0));
    entries.push({ dayId, sets: data.sets, vol, maxW, note: data.note, date: data.loggedAt });
  });
  // Most recent first, cap at 3
  return entries.sort((a,b)=>(b.date||0)-(a.date||0)).slice(0,3);
}

// ── EXERCISE CARD ─────────────────────────────────────────────────────────────
function ExCard({ex, logData, onLogChange, checked, onCheck, fullLog, dayId}) {
  const [open,      setOpen]      = useState(false);
  const [histOpen,  setHistOpen]  = useState(false);
  const [videoOpen, setVideoOpen] = useState(false);
  const sets  = logData?.sets || [];
  const note  = logData?.note || "";
  const upSets = s => onLogChange({...logData, sets: s, exName: ex.name, loggedAt: Date.now()});
  const addSet = () => {
    // Pre-fill from last session's first set if available
    const history = getExerciseHistory(ex.name, dayId, fullLog || {});
    const lastSets = history[0]?.sets || [];
    const lastSet  = lastSets[sets.length] || lastSets[lastSets.length-1] || {};
    const prev = sets[sets.length-1] || {};
    upSets([...sets, {weight: prev.weight || lastSet.weight || "", reps: prev.reps || lastSet.reps || "", rpe: ""}]);
  };
  const upSet  = (i,s) => { const n=[...sets]; n[i]=s; onLogChange({...logData, sets:n, exName:ex.name, loggedAt:Date.now()}); };
  const rmSet  = i => upSets(sets.filter((_,j)=>j!==i));
  const vol    = sets.reduce((a,s)=>a+(parseFloat(s.weight)||0)*(parseInt(s.reps)||0),0);

  const history = fullLog ? getExerciseHistory(ex.name, dayId, fullLog) : [];
  ...
  const getEmbedUrl = (url) => {
    ...
    try {
      ...
      const full = url.match(/(?:v=|\/embed\/|\/shorts\/)([a-zA-Z0-9_-]{11})/);
      if (full) return `https://www.youtube-nocookie.com/embed/${full[1]}?rel=0&modestbranding=1`;
    } catch {}
    return null;
  };
    ...
    <div className={`ex-card fu ${checked?"done":""}`}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:12,padding:"14px 16px",cursor:"pointer"}} onClick={()=>setOpen(!open)}>
        ...
        <div style={{display:"flex",gap:8,alignItems:"center"}}>
          ...
          {/* History button — only shown if there's history */}
          {history.length > 0 && (
            <button
              onClick={e=>{e.stopPropagation();setHistOpen(h=>!h);setOpen(true);}}
              style={{
                padding:"3px 8px",borderRadius:99,border:"1.5px solid",cursor:"pointer",
                fontFamily:"'DM Sans'",fontSize:10,fontWeight:700,transition:"all .15s",
                background: histOpen ? "#1a1a1a" : "transparent",
                color:      histOpen ? "#c8f040" : "#bbb",
                borderColor:histOpen ? "#1a1a1a" : "#e0dbd0",
              }}
          ...
          {embedUrl && (
            <button
              ...
              style={{
                ...
                background:videoOpen?"#1a1a1a":"#f0ebe0",
                display:"flex",alignItems:"center",justifyContent:"center",
                flexShrink:0,transition:"background .15s",
              }}
              title={videoOpen?"Hide video":"Watch demo"}
            >
              {videoOpen
                ? <svg width="10" height="10" viewBox="0 0 10 10" fill="none"><rect x="2" y="1" width="2.5" height="8" rx="1" fill="#c8f040"/><rect x="5.5" y="1" width="2.5" height="8" rx="1" fill="#c8f040"/></svg>
                : <svg width="10" height="12" viewBox="0 0 10 12" fill="none"><path d="M1 1.5L9 6L1 10.5V1.5Z" fill="#888" stroke="#888" strokeWidth="0.5" strokeLinejoin="round"/></svg>
              }
            </button>
          )}
      ...
      {open && (
        <div style={{padding:"0 16px 16px",borderTop:"2px solid #f5f0e8"}}>
          ...
          {histOpen && history.length > 0 && (
            <div style={{background:"#f8f5ef",borderRadius:12,padding:"12px 14px",marginTop:12,marginBottom:14}}>
              <div style={{fontFamily:"'DM Sans'",fontSize:10,fontWeight:700,color:"#bbb",textTransform:"uppercase",letterSpacing:"0.07em",marginBottom:10}}>Previous sessions</div>
              {history.map((h, hi) => (
                <div key={hi} style={{marginBottom: hi < history.length-1 ? 10 : 0, paddingBottom: hi < history.length-1 ? 10 : 0, borderBottom: hi < history.length-1 ? "1px solid #eee" : "none"}}>
                  <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
                    <span style={{fontFamily:"'DM Sans'",fontSize:11,fontWeight:600,color:"#999"}}>Session {history.length - hi}</span>
                    <div style={{display:"flex",gap:8}}>
                      {h.maxW > 0 && <span style={{fontFamily:"'DM Sans'",fontSize:11,fontWeight:700,color:"#555"}}>{h.maxW} lbs top</span>}
                      {h.vol > 0 && <span style={{fontFamily:"'DM Sans'",fontSize:11,color:"#aaa"}}>{h.vol.toLocaleString()} total</span>}
                    </div>
                  </div>
                  <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
                    {h.sets.map((s,si) => (
                      <div key={si} style={{background:"#fff",borderRadius:8,padding:"4px 8px",border:"1px solid #ede8de"}}>
                        <span style={{fontFamily:"'DM Sans'",fontSize:11,color:"#555"}}>
                  ...
                  {h.note && <div style={{fontFamily:"'DM Sans'",fontSize:11,color:"#999",fontStyle:"italic",marginTop:4}}>"{h.note}"</div>}
                </div>
              ))}
            </div>
          )}
          ...
          <div>
            ...
            <input className="inp" value={note} onChange={e=>onLogChange({...logData,note:e.target.value,exName:ex.name,loggedAt:Date.now()})} placeholder="Optional note…" style={{fontSize:13}}/>
          </div>
        </div>
      )}
    </div>
...
// ── WORKOUT PAGE ──────────────────────────────────────────────────────────────
// Finds the first week+day where not all exercises are checked
function findNextWorkout(plan, log) {
  for (let wi = 0; wi < plan.weeks.length; wi++) {
    const week = plan.weeks[wi];
    for (let di = 0; di < week.days.length; di++) {
      const day = week.days[di];
      const allDone = day.exercises.length > 0 &&
        day.exercises.every(ex => log[`${day.id}::${ex.id}`]?.checked);
      if (!allDone) return { wi, di };
    }
  }
  // All done — return last day
  const lastWi = plan.weeks.length - 1;
  return { wi: lastWi, di: plan.weeks[lastWi].days.length - 1 };
}

function WorkoutPage({plan}) {
  const [log, setLog] = useState(() => store.get("wlog") || {});

  // Auto-advance: initialise to next uncompleted workout
  const [wk, setWk] = useState(() => findNextWorkout(plan, store.get("wlog") || {}).wi);
  const [dy, setDy] = useState(() => findNextWorkout(plan, store.get("wlog") || {}).di);
  ...
  const setExLog = (id, data) => {
    const u = {...log, [`${day.id}::${id}`]: data};
    setLog(u);
    store.set("wlog", u);
  };

  // When all exercises on this day become checked, show a nudge
  const allDone = day.exercises.length > 0 && day.exercises.every(ex => getLog(ex.id).checked);

  // Advance to next uncompleted day (used by nudge button)
  const goToNext = () => {
    const {wi, di} = findNextWorkout(plan, log);
    setWk(wi); setDy(di);
  };

  const sections = groupBySection(day.exercises);

  // Which days are fully complete (for visual badge on day buttons)
  const isDayComplete = (w, d) => {
    const day = plan.weeks[w]?.days?.[d];
    if (!day || !day.exercises.length) return false;
    return day.exercises.every(ex => log[`${day.id}::${ex.id}`]?.checked);
  };
  ...
  return (
    <div>
      ...
      <div style={{display:"flex",gap:6,flexWrap:"wrap",marginBottom:10}}>
        {plan.weeks.map((w,i)=>{
          const weekDone = w.days.every((_,di)=>isDayComplete(i,di));
          return (
            <button key={i} className={`week-btn ${safeWk===i?"on":""}`}
              onClick={()=>{setWk(i);setDy(0);}}
              style={{position:"relative"}}
            >
              W{w.week}
              {weekDone && <span style={{position:"absolute",top:-4,right:-4,width:8,height:8,borderRadius:"50%",background:"#c8f040",border:"2px solid #f5f0e8"}}/>}
            </button>
          );
        })}
      </div>
      ...
      <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:24}}>
        {plan.weeks[safeWk].days.map((d,i)=>{
          const done = isDayComplete(safeWk, i);
          return (
            <button key={i} className={`day-btn ${safeDy===i?"on":""}`} onClick={()=>setDy(i)}
              style={{position:"relative"}}
            >
              <span>{d.emoji}</span>{d.label}
              {done && <span style={{marginLeft:4,fontSize:10,color:safeDy===i?"#c8f040":"#5a7a00"}}>✓</span>}
            </button>
          );
        })}
      </div>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",marginBottom:16}}>
        <div>
          ...
          <div style={{fontFamily:"'DM Sans'",fontSize:12,color:"#aaa",marginTop:2,fontWeight:500}}>
            Week {safeWk+1} · Phase {plan.weeks[safeWk].phase} · {day.exercises.length} exercises
          </div>
        </div>
      ...
      {/* All-done nudge */}
      {allDone && (
        <div style={{background:"#c8f040",borderRadius:16,padding:"14px 18px",marginBottom:16,display:"flex",alignItems:"center",justifyContent:"space-between",gap:12}}>
          <div style={{fontFamily:"'DM Sans'",fontSize:13,fontWeight:700,color:"#1a1a1a"}}>
            Session complete 🎉
          </div>
          <button className="btn-dark" style={{fontSize:12,padding:"7px 16px",flexShrink:0}} onClick={goToNext}>
            Next workout →
          </button>
        </div>
      )}
